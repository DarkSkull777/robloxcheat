...
Title.TextSize = 18
Title.Text = "Dymles Ganz 1337 Hacks"
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'tpall', DESC = 'Dymles Ganz Teleport All Player.'}
CMDs[#CMDs + 1] = {NAME = 'untpall', DESC = 'Dymles Ganz UnTeleport'}
...
CMDs[#CMDs + 1] = {NAME = 'uninvisfling', DESC = 'Disable invisible fling (the invis part is patched, try using the god command before using this)'}
...
addcmd("tpall", {}, function(args, speaker)
    if tpallRunning then return end -- biar gak dobel
    tpallRunning = true
    spawn(function()
            ...
            for _, player in pairs(game.Players:GetPlayers()) do
                if player ~= game.Players.LocalPlayer and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if localChar and localChar.PrimaryPart then
                        localChar:SetPrimaryPartCFrame(player.Character.HumanoidRootPart.CFrame)
                    end
                    wait(0.5)
                end
            end
...
addcmd("untpall", {}, function(args, speaker)
    tpallRunning = false
end)
...
addcmd('uninvisfling',{},function(args, speaker)
    local ch = speaker.Character
    ...
    for _, v in pairs(ch:GetChildren()) do
        if v:IsA("Humanoid") and v ~= ch:FindFirstChildOfClass("Humanoid") then
            v:Destroy()
        end
    end
